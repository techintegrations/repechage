  ...
  theme.CartForm = (function() {
    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      function removeProductFromCart(variantId) {
          ...
          // Fetch the cart data to find the item key for the given variant ID
          fetch('/cart.js')
            .then(response => response.json())
            .then(cart => {
              ...
              if (cartItemKey) {
                theme.cart.changeItem(cartItemKey, 0)
                  .then(() => {
                    console.log('Sample product removed from cart:', cartItemKey);
                    // Rebuild the cart after removing the item
